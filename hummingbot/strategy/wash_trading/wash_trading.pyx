...
from .wash_trading_order_tracker import WashTradingOrderTracker
...
cdef class WashTradingStrategy(StrategyBase):
    ...
    def logger(cls):
        global wt_logger
        if wt_logger is None:
            wt_logger = logging.getLogger(__name__)
        return wt_logger
    ...
    def init_params(self,
                    ...
                    wash_trade_sell_first: bool = True,
        ...
        self._sb_order_tracker = WashTradingOrderTracker()
        ...
        self._wash_trade_sell_first = wash_trade_sell_first
    ...
    @property
    def wash_trade_sell_first(self) -> bool:
        return self._wash_trade_sell_first
    ...
    def wash_trade_order_min_amount(self) -> Decimal:
        return self._wash_trade_order_min_amount

    @property
    def wash_trade_order_max_amount(self) -> Decimal:
        return self._wash_trade_order_max_amount
    ...
    cdef c_tick(self, double timestamp):
        ...
        try:
            ...
            if self._create_timestamp <= self._current_timestamp:
                ...
                if self._wash_trade_enabled and self._wash_trade_spread > s_decimal_zero and self._wash_trade_order_min_amount > s_decimal_zero:
                    self.c_add_wash_orders(proposal)
    ...
    cdef c_add_wash_orders(self, object proposal):
        cdef:
            ExchangeBase market = self._market_info.market
    ...
    cdef c_execute_orders_proposal(self, object proposal):
        ...
        if self._wash_trade_sell_first:
            if len(proposal.sells) > 0:
