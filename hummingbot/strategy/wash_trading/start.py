...
from hummingbot.strategy.wash_trading import InventoryCostPriceDelegate, WashTradingStrategy
from hummingbot.strategy.wash_trading.moving_price_band import MovingPriceBand
from hummingbot.strategy.wash_trading.wash_trading_config_map import wash_trading_config_map as c_map
...
def start(self):
    ...
    try:
        ...
        strategy_logging_options = WashTradingStrategy.OPTION_LOG_ALL
        self.strategy = WashTradingStrategy()
